@echo off
echo Running Git Push Script for Teaching and Learning With AI
echo ==========================================

echo Setting remote repository to https://github.com/fenago/TeachingAndLearningWithAI...
git remote remove origin 2>nul
git remote add origin https://github.com/fenago/TeachingAndLearningWithAI.git
...
if /i "%confirm%"=="Y" (
  echo Pushing to GitHub repository: https://github.com/fenago/TeachingAndLearningWithAI
